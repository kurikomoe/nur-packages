# This file was generated by nvfetcher, please do not modify it manually.
{
  ...
  devenv = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "v1.8";
      fetchSubmodules = false;
      sha256 = "sha256-Cg4DxHCZiXiSlbwveJpyCFzWIblWi467I2/pmsAWiAw=";
    };
  };
  dotnet-script = {
    pname = "dotnet-script";
  ...
  nix-vscode-extensions = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "master";
      fetchSubmodules = false;
      sha256 = "sha256-U4fomCfnCPhQo2R/XWXdHQ9VATFlqVpPEG52Ve6ukm4=";
    };
  };
  pwndbg = {
    pname = "pwndbg";
  ...
  python = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "main";
      fetchSubmodules = false;
      sha256 = "sha256-d9GpIG7qaiS74GI7GEXdEWJEMyFZrU/zF61FQHNvvZw=";
    };
  };
  shellfirm = {
    pname = "shellfirm";
